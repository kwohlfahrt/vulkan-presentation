...
int main(void) {
    ...
    for (size_t i = 0; i < NELEMS(image_buffers); i++)
        createBuffer(memory_properties, device, VK_BUFFER_USAGE_TRANSFER_DST_BIT, render_size.height * render_size.width * 4, NULL, &image_buffers[i], &image_buffer_memories[i]);
